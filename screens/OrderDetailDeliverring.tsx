...
const OrderDetailDeliverring = ({ route, navigation }: any) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.headerTitle}>Order Detail  <Text style={styles.gettingStartedButtonText}>{(() => {
      ...
      <>
        {(() => {
          switch (order?.deliveringStatus) {
            case 2:
              return <TouchableOpacity style={styles.checkoutButton}
                onPress={() =>  changeStatusOrder(3, orderId)}  >
                <View >
                  <Text style={styles.checkoutText}> Next Order processing</Text>
                </View>
              </TouchableOpacity>;
            case 3:
              return <TouchableOpacity style={styles.checkoutButton}
                onPress={() => changeStatusOrder(4, orderId)}  >
                <View >
                  <Text style={styles.checkoutText}> Next On Thy Way </Text>
                </View>
              </TouchableOpacity>;
            case 4:
              return <TouchableOpacity style={styles.checkoutButton}
                onPress={() => changeStatusOrder(5, orderId)}  >
                <View >
                  <Text style={styles.checkoutText}> Deliverred</Text>
                </View>
              </TouchableOpacity>;
          }
        })()}
...
export default OrderDetailDeliverring;